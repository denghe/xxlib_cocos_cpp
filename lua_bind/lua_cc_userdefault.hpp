...
inline void Lua_Register_UserDefault(lua_State* const& L)
{
	Lua_NewFunc(L, "getBoolForKey", [](lua_State* L)
	{
		...
		case 1:
		{
			auto&& t = Lua_ToTuple<const char*>(L);
			r = cocos2d::UserDefault::getInstance()->getBoolForKey(std::get<0>(t));
			break;
		}
		case 2:
		{
			auto&& t = Lua_ToTuple<const char*, bool>(L);
	...
	Lua_NewFunc(L, "getIntegerForKey", [](lua_State* L)
	{
		...
		case 2:
		{
			auto&& t = Lua_ToTuple<const char*, int>(L);
	...
	Lua_NewFunc(L, "getFloatForKey", [](lua_State* L)
	{
		...
		case 2:
		{
			auto&& t = Lua_ToTuple<const char*, float>(L);
	...
	Lua_NewFunc(L, "getDoubleForKey", [](lua_State* L)
	{
		...
		case 2:
		{
			auto&& t = Lua_ToTuple<const char*, double>(L);
	...
	Lua_NewFunc(L, "getStringForKey", [](lua_State* L)
	{
		...
		case 2:
		{
			auto&& t = Lua_ToTuple<const char*, std::string>(L);
	...
	Lua_NewFunc(L, "getDataForKey", [](lua_State* L)
	{
		...
		{
			auto&& t = Lua_ToTuple<const char*>(L);
			auto&& r = cocos2d::UserDefault::getInstance()->getDataForKey(std::get<0>(t));
			auto&& data = new cocos2d::Data(std::move(r));
			return Lua_Pushs(L, data);
		}
		case 2:
		{
			auto&& t = Lua_ToTuple<const char*, cocos2d::Data*>(L);
			auto&& r = cocos2d::UserDefault::getInstance()->getDataForKey(std::get<0>(t), *std::get<1>(t));
			auto&& data = new cocos2d::Data(std::move(r));
			return Lua_Pushs(L, data);
		}
		default:
	...
	{
		auto&& t = Lua_ToTuple<char const*, bool>(L, "setBoolForKey error! need 2 args: string key, bool value");
	...
	{
		auto&& t = Lua_ToTuple<char const*, int>(L, "setIntegerForKey error! need 2 args: string key, int32 value");
	...
	{
		auto&& t = Lua_ToTuple<char const*, float>(L, "setFloatForKey error! need 2 args: string key, float value");
	...
	{
		auto&& t = Lua_ToTuple<char const*, double>(L, "setDoubleForKey error! need 2 args: string key, double value");
	...
	{
		auto&& t = Lua_ToTuple<char const*, std::string>(L, "setStringForKey error! need 2 args: string key, string value");
	...
	{
		auto&& t = Lua_ToTuple<char const*, cocos2d::Data*>(L, "setDataForKey error! need 2 args: string key, Data data");
	...
	{
		auto&& t = Lua_ToTuple<char const*>(L, "deleteValueForKey error! need 1 args: string key");
