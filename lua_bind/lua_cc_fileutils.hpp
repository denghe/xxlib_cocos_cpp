...
inline void Lua_Register_FileUtils(lua_State* const& L)
{
	...
	Lua_NewFunc(L, "getStringFromFile", [](lua_State* L)
	{
		...
		case 1:
		{
			...
			auto&& r = cocos2d::FileUtils::getInstance()->getStringFromFile(std::get<0>(t));
	...
	Lua_NewFunc(L, "getDataFromFile", [](lua_State* L)
	{
		...
		{
			auto&& t = Lua_ToTuple<std::string>(L);
			auto&& r = cocos2d::FileUtils::getInstance()->getDataFromFile(std::get<0>(t));
			auto&& data = new cocos2d::Data(std::move(r));
		...
		case 2:
		{
			...
			{
				auto&& d = new cocos2d::Data(std::move(data));
				assert(!lua_gettop(gLua));
				Lua_PCall(gLua, f, d);
				lua_settop(gLua, 0);
			});
	...
	Lua_NewFunc(L, "getFileDataFromZip", [](lua_State* L)
	{
		...
		ssize_t size = 0;
		auto&& r = cocos2d::FileUtils::getInstance()->getFileDataFromZip(std::get<0>(t), std::get<1>(t), &size);
		auto&& d = new cocos2d::Data();
		d->fastSet(r, size);
	...
	{
		auto&& t = Lua_ToTuple<std::string>(L, "fullPathForFilename error! need 1 args: string filename");
		auto&& r = cocos2d::FileUtils::getInstance()->fullPathForFilename(std::get<0>(t));
		return Lua_Pushs(L, r);
	});
	...
	{
		auto&& t = Lua_ToTuple<std::string, std::string>(L, "fullPathFromRelativeFile error! need 2 args: string filename, relativeFile");
		auto&& r = cocos2d::FileUtils::getInstance()->fullPathFromRelativeFile(std::get<0>(t), std::get<1>(t));
		return Lua_Pushs(L, r);
	});
	...
	{
		auto&& r = cocos2d::FileUtils::getInstance()->getDefaultResourceRootPath();
		return Lua_Pushs(L, r);
	});

	Lua_NewFunc(L, "setDefaultResourceRootPath", [](lua_State* L)
	{
		auto&& t = Lua_ToTuple<std::string>(L, "setDefaultResourceRootPath error! need 1 args: string path");
	...
	{
		auto&& t = Lua_ToTuple<std::string, bool>(L, "addSearchPath error! need 2 args: string path, bool front");
	...
	{
		auto&& r = cocos2d::FileUtils::getInstance()->getSearchPaths();
		return Lua_Pushs(L, r);
	});

	Lua_NewFunc(L, "getOriginalSearchPaths", [](lua_State* L)
	{
		auto&& r = cocos2d::FileUtils::getInstance()->getOriginalSearchPaths();
		return Lua_Pushs(L, r);
	});

	Lua_NewFunc(L, "getWritablePath", [](lua_State* L)
	{
		auto&& r = cocos2d::FileUtils::getInstance()->getWritablePath();
		return Lua_Pushs(L, r);
	});

	Lua_NewFunc(L, "setWritablePath", [](lua_State* L)
	{
		auto&& t = Lua_ToTuple<std::string, bool>(L, "setWritablePath error! need 2 args: string writablePath");
	...
	{
		auto&& t = Lua_ToTuple<bool>(L, "setPopupNotify error! need 1 args: bool notify");
	...
	{
		auto&& r = cocos2d::FileUtils::getInstance()->isPopupNotify();
		return Lua_Pushs(L, r);
	});
	...
	Lua_NewFunc(L, "writeStringToFile", [](lua_State* L)
	{
		...
		case 1:
		{
			...
			auto&& r = cocos2d::FileUtils::getInstance()->writeStringToFile(std::get<0>(t), std::get<1>(t));
			return Lua_Pushs(L, r);
		}
		case 2:
		{
			auto&& t = Lua_ToTuple<std::string, std::string, Lua_Func>(L);
	...
	Lua_NewFunc(L, "writeDataToFile", [](lua_State* L)
	{
		...
		case 1:
		{
			auto&& t = Lua_ToTuple<cocos2d::Data*, std::string>(L);
			auto&& r = cocos2d::FileUtils::getInstance()->writeDataToFile(*std::get<0>(t), std::get<1>(t));
			return Lua_Pushs(L, r);
		}
		case 2:
		{
			auto&& t = Lua_ToTuple<cocos2d::Data*, std::string, Lua_Func>(L);
	...
	Lua_NewFunc(L, "isFileExist", [](lua_State* L)
	{
		...
		{
			auto&& t = Lua_ToTuple<std::string>(L);
			auto&& r = cocos2d::FileUtils::getInstance()->isFileExist(std::get<0>(t));
			return Lua_Pushs(L, r);
		}
		case 2:
		{
	...
	{
		auto&& t = Lua_ToTuple<std::string>(L, "getFileExtension error! need 1 args: string filePath");
		auto&& r = cocos2d::FileUtils::getInstance()->getFileExtension(std::get<0>(t));
		return Lua_Pushs(L, r);
	});

	Lua_NewFunc(L, "isAbsolutePath", [](lua_State* L)
	{
		auto&& t = Lua_ToTuple<std::string>(L, "isAbsolutePath error! need 1 args: string path");
		auto&& r = cocos2d::FileUtils::getInstance()->isAbsolutePath(std::get<0>(t));
		return Lua_Pushs(L, r);
	});
	...
	Lua_NewFunc(L, "isDirectoryExist", [](lua_State* L)
	{
		...
		{
			auto&& t = Lua_ToTuple<std::string>(L);
			auto&& r = cocos2d::FileUtils::getInstance()->isDirectoryExist(std::get<0>(t));
			return Lua_Pushs(L, r);
		}
		case 2:
		{
	...
	Lua_NewFunc(L, "createDirectory", [](lua_State* L)
	{
		...
		{
			auto&& t = Lua_ToTuple<std::string>(L);
			auto&& r = cocos2d::FileUtils::getInstance()->createDirectory(std::get<0>(t));
			return Lua_Pushs(L, r);
		}
		case 2:
		{
	...
	Lua_NewFunc(L, "removeDirectory", [](lua_State* L)
	{
		...
		{
			auto&& t = Lua_ToTuple<std::string>(L);
			auto&& r = cocos2d::FileUtils::getInstance()->removeDirectory(std::get<0>(t));
			return Lua_Pushs(L, r);
		}
		case 2:
		{
	...
	Lua_NewFunc(L, "removeFile", [](lua_State* L)
	{
		...
		{
			auto&& t = Lua_ToTuple<std::string>(L);
			auto&& r = cocos2d::FileUtils::getInstance()->removeFile(std::get<0>(t));
			return Lua_Pushs(L, r);
		}
		case 2:
		{
	...
	Lua_NewFunc(L, "renameFile", [](lua_State* L)
	{
		...
		case 1:
		{
			...
			auto&& r = cocos2d::FileUtils::getInstance()->renameFile(std::get<0>(t), std::get<1>(t), std::get<2>(t));
			return Lua_Pushs(L, r);
		}
		case 2:
		{
			auto&& t = Lua_ToTuple<std::string, std::string, std::string, Lua_Func>(L);
	...
	Lua_NewFunc(L, "getFileSize", [](lua_State* L)
	{
		...
		{
			auto&& t = Lua_ToTuple<std::string>(L);
			auto&& r = cocos2d::FileUtils::getInstance()->getFileSize(std::get<0>(t));
			return Lua_Pushs(L, r);
		}
		case 2:
		{
	...
	Lua_NewFunc(L, "listFiles", [](lua_State* L)
	{
		...
		{
			auto&& t = Lua_ToTuple<std::string>(L);
			auto&& r = cocos2d::FileUtils::getInstance()->listFiles(std::get<0>(t));
			return Lua_Pushs(L, r);
		}
		case 2:
		{
	...
	{
		auto&& r = cocos2d::FileUtils::getInstance()->getFullPathCache();
		return Lua_Pushs(L, r);
	});

	Lua_NewFunc(L, "getNewFilename", [](lua_State* L)
	{
		auto&& t = Lua_ToTuple<std::string>(L, "getNewFilename error! need 1 args: string filename");
		auto&& r = cocos2d::FileUtils::getInstance()->getNewFilename(std::get<0>(t));
		return Lua_Pushs(L, r);
	});
}
