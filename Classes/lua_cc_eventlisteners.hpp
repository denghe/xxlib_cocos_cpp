...
inline void Lua_Register_EventListenerTouchAllAtOnce(lua_State* const& L)
{
	...
	{
		var t = Lua_ToTuple<cocos2d::EventListenerTouchAllAtOnce*, Lua_FuncHolder>(L, "onTouchesBegan error! need 2 args: self, func/null");
	...
	{
		var t = Lua_ToTuple<cocos2d::EventListenerTouchAllAtOnce*, Lua_FuncHolder>(L, "onTouchesMoved error! need 2 args: self, func/null");
		if (std::get<1>(t).funcId)
		{
	...
	{
		var t = Lua_ToTuple<cocos2d::EventListenerTouchAllAtOnce*, Lua_FuncHolder>(L, "onTouchesEnded error! need 2 args: self, func/null");
		if (std::get<1>(t).funcId)
		{
	...
	{
		var t = Lua_ToTuple<cocos2d::EventListenerTouchAllAtOnce*, Lua_FuncHolder>(L, "onTouchesCancelled error! need 2 args: self, func/null");
		if (std::get<1>(t).funcId)
		{
...
inline void Lua_Register_EventListenerTouchOneByOne(lua_State* const& L)
{
	...
	{
		var t = Lua_ToTuple<cocos2d::EventListenerTouchOneByOne*, Lua_FuncHolder>(L, "onTouchBegan error! need 2 args: self, func/null");
		if (std::get<1>(t).funcId)
		{
	...
	{
		var t = Lua_ToTuple<cocos2d::EventListenerTouchOneByOne*, Lua_FuncHolder>(L, "onTouchMoved error! need 2 args: self, func/null");
		if (std::get<1>(t).funcId)
		{
	...
	{
		var t = Lua_ToTuple<cocos2d::EventListenerTouchOneByOne*, Lua_FuncHolder>(L, "onTouchEnded error! need 2 args: self, func/null");
		if (std::get<1>(t).funcId)
		{
	...
	{
		var t = Lua_ToTuple<cocos2d::EventListenerTouchOneByOne*, Lua_FuncHolder>(L, "onTouchCancelled error! need 2 args: self, func/null");
		if (std::get<1>(t).funcId)
		{
