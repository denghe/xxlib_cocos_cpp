...
inline void Lua_Register_spine(lua_State* const& L)
{
	...
	*/
	...
	{
		var t = Lua_ToTuple<spine::SkeletonRenderer*>(L, "getSkeleton error! need 1 args: self");
		var r = std::get<0>(t)->getSkeleton();
		return Lua_Pushs(L, r);
	});

	Lua_NewFunc(L, "setTimeScale", [](lua_State* L)
	{
		var t = Lua_ToTuple<spine::SkeletonRenderer*, float>(L, "setTimeScale error! need 2 args: self, float scale");
	...
	{
		var t = Lua_ToTuple<spine::SkeletonRenderer*>(L, "getTimeScale error! need 1 args: self");
		var r = std::get<0>(t)->getTimeScale();
		return Lua_Pushs(L, r);
	});

	Lua_NewFunc(L, "setDebugSlotsEnabled", [](lua_State* L)
	{
		var t = Lua_ToTuple<spine::SkeletonRenderer*, bool>(L, "setDebugSlotsEnabled error! need 2 args: self, bool enabled");
	...
	{
		var t = Lua_ToTuple<spine::SkeletonRenderer*>(L, "getDebugSlotsEnabled error! need 1 args: self");
		var r = std::get<0>(t)->getDebugSlotsEnabled();
		return Lua_Pushs(L, r);
	});

	Lua_NewFunc(L, "setDebugBonesEnabled", [](lua_State* L)
	{
		var t = Lua_ToTuple<spine::SkeletonRenderer*, bool>(L, "setDebugBonesEnabled error! need 2 args: self, bool enabled");
	...
	{
		var t = Lua_ToTuple<spine::SkeletonRenderer*>(L, "getDebugBonesEnabled error! need 1 args: self");
		var r = std::get<0>(t)->getDebugBonesEnabled();
		return Lua_Pushs(L, r);
	});

	Lua_NewFunc(L, "setDebugMeshesEnabled", [](lua_State* L)
	{
		var t = Lua_ToTuple<spine::SkeletonRenderer*, bool>(L, "setDebugMeshesEnabled error! need 2 args: self, bool enabled");
	...
	{
		var t = Lua_ToTuple<spine::SkeletonRenderer*>(L, "getDebugMeshesEnabled error! need 1 args: self");
		var r = std::get<0>(t)->getDebugMeshesEnabled();
		return Lua_Pushs(L, r);
	});

	Lua_NewFunc(L, "updateWorldTransform", [](lua_State* L)
	{
		var t = Lua_ToTuple<spine::SkeletonRenderer*>(L, "updateWorldTransform error! need 1 args: self");
	...
	{
		var t = Lua_ToTuple<spine::SkeletonRenderer*>(L, "setToSetupPose error! need 1 args: self");
	...
	{
		var t = Lua_ToTuple<spine::SkeletonRenderer*>(L, "setBonesToSetupPose error! need 1 args: self");
	...
	{
		var t = Lua_ToTuple<spine::SkeletonRenderer*>(L, "setSlotsToSetupPose error! need 1 args: self");
	...
	{
		var t = Lua_ToTuple<spine::SkeletonRenderer*, std::string>(L, "findBone error! need 2 args: self, string boneName");
		var r = std::get<0>(t)->findBone(std::get<1>(t));
		if (!r) return 0;
		return Lua_Pushs(L, r);
	});
	...
	{
		var t = Lua_ToTuple<spine::SkeletonRenderer*, std::string>(L, "findSlot error! need 2 args: self, string slotName");
		var r = std::get<0>(t)->findSlot(std::get<1>(t));
		if (!r) return 0;
		return Lua_Pushs(L, r);
	});
	...
	{
		var t = Lua_ToTuple<spine::SkeletonRenderer*, char const*>(L, "setSkin error! need 2 args: self, string skinName");
		var r = std::get<0>(t)->setSkin(std::get<1>(t));
		return Lua_Pushs(L, r);
	});

	Lua_NewFunc(L, "getAttachment", [](lua_State* L)
	{
		var t = Lua_ToTuple<spine::SkeletonRenderer*, std::string, std::string>(L, "getAttachment error! need 3 args: self, string slotName, attachmentName");
		var r = std::get<0>(t)->getAttachment(std::get<1>(t), std::get<2>(t));
		return Lua_Pushs(L, r);
	});

	Lua_NewFunc(L, "setAttachment", [](lua_State* L)
	{
		var t = Lua_ToTuple<spine::SkeletonRenderer*, std::string, char const*>(L, "setAttachment error! need 3 args: self, string slotName, attachmentName");
		var r = std::get<0>(t)->setAttachment(std::get<1>(t), std::get<2>(t));
		return Lua_Pushs(L, r);
	});

	Lua_NewFunc(L, "setTwoColorTint", [](lua_State* L)
	{
		var t = Lua_ToTuple<spine::SkeletonRenderer*, bool>(L, "setTwoColorTint error! need 2 args: self, bool enabled");
	...
	{
		var t = Lua_ToTuple<spine::SkeletonRenderer*>(L, "isTwoColorTint error! need 1 args: self");
		var r = std::get<0>(t)->isTwoColorTint();
		return Lua_Pushs(L, r);
	});

	//Lua_NewFunc(L, "setVertexEffect", [](lua_State* L)
	//{
	//	var t = Lua_ToTuple<spine::SkeletonRenderer*, spVertexEffect*>(L, "setVertexEffect error! need 2 args: self, spVertexEffect effect");
	...
	Lua_NewFunc(L, "createWithData", [](lua_State* L)
	{
		...
		case 1:
		{
			var t = Lua_ToTuple<spSkeletonData*>(L);
			var o = spine::SkeletonAnimation::createWithData(std::get<0>(t));
			break;
		}
		case 2:
		{
			var t = Lua_ToTuple<spSkeletonData*, bool>(L);
			var o = spine::SkeletonAnimation::createWithData(std::get<0>(t), std::get<1>(t));
			break;
		}
		default:
	...
	Lua_NewFunc(L, "createWithJsonFile", [](lua_State* L)
	{
		...
		case 2:
		{
			if (lua_isstring(L, 2))
			{
				...
				var o = spine::SkeletonAnimation::createWithJsonFile(std::get<0>(t), std::get<1>(t));
			}
			else
			{
		...
		case 3:
		{
			if (lua_isstring(L, 2))
			{
				...
				var o = spine::SkeletonAnimation::createWithJsonFile(std::get<0>(t), std::get<1>(t), std::get<2>(t));
			}
			else
			{
	...
	{
		var t = Lua_ToTuple<spine::SkeletonAnimation*, spAnimationStateData*>(L, "setAnimationStateData error! need 2 args: self, spAnimationStateData stateData");
	...
	{
		var t = Lua_ToTuple<spine::SkeletonAnimation*, std::string, std::string, float>(L, "setMix error! need 2 args: self, string fromAnimation, toAnimation, float duration");
	...
	{
		var t = Lua_ToTuple<spine::SkeletonAnimation*, int, std::string, bool>(L, "setAnimation error! need 4 args: self, int trackIndex, string name, bool loop");
		var o = std::get<0>(t)->addAnimation(std::get<1>(t), std::get<2>(t), std::get<3>(t));
		if (!o) return 0;
		return Lua_Pushs(L, o);
	});
	...
	Lua_NewFunc(L, "addAnimation", [](lua_State* L)
	{
		...
		case 3:
		{
			var t = Lua_ToTuple<spine::SkeletonAnimation*, int, std::string, bool>(L);
			o = std::get<0>(t)->addAnimation(std::get<1>(t), std::get<2>(t), std::get<3>(t));
			break;
		}
		case 4:
		{
			var t = Lua_ToTuple<spine::SkeletonAnimation*, int, std::string, bool, float>(L);
	...
	{
		var t = Lua_ToTuple<spine::SkeletonAnimation*, int, float>(L, "setEmptyAnimation error! need 4 args: self, int trackIndex, float mixDuration");
		var o = std::get<0>(t)->setEmptyAnimation(std::get<1>(t), std::get<2>(t));
		if (!o) return 0;
		return Lua_Pushs(L, o);
	});
	...
	{
		var t = Lua_ToTuple<spine::SkeletonAnimation*, float>(L, "setEmptyAnimations error! need 2 args: self, float mixDuration");
	...
	Lua_NewFunc(L, "addEmptyAnimation", [](lua_State* L)
	{
		...
		case 3:
		{
			var t = Lua_ToTuple<spine::SkeletonAnimation*, int, float>(L);
			o = std::get<0>(t)->addEmptyAnimation(std::get<1>(t), std::get<2>(t));
			break;
		}
		case 4:
		{
			var t = Lua_ToTuple<spine::SkeletonAnimation*, int, float, float>(L);
	...
	{
		var t = Lua_ToTuple<spine::SkeletonAnimation*, std::string>(L, "findAnimation error! need 2 args: self, string name");
		var o = std::get<0>(t)->findAnimation(std::get<1>(t));
		if (!o) return 0;
		return Lua_Pushs(L, o);
	});
	...
	Lua_NewFunc(L, "getCurrent", [](lua_State* L)
	{
		...
		case 1:
		{
			var t = Lua_ToTuple<spine::SkeletonAnimation*>(L);
			o = std::get<0>(t)->getCurrent();
			break;
		}
		case 2:
		{
			var t = Lua_ToTuple<spine::SkeletonAnimation*, int>(L);
	...
	{
		var t = Lua_ToTuple<spine::SkeletonAnimation*>(L, "clearTracks error! need 1 args: self");
	...
	{
		var t = Lua_ToTuple<spine::SkeletonAnimation*, Lua_Func>(L, "setStartListener error! need 2 args: self, function<void(spTrackEntry entry)>");
	...
	{
		var t = Lua_ToTuple<spine::SkeletonAnimation*, Lua_Func>(L, "setInterruptListener error! need 2 args: self, function<void(spTrackEntry entry)>");
	...
	{
		var t = Lua_ToTuple<spine::SkeletonAnimation*, Lua_Func>(L, "setEndListener error! need 2 args: self, function<void(spTrackEntry entry)>");
	...
	{
		var t = Lua_ToTuple<spine::SkeletonAnimation*, Lua_Func>(L, "setDisposeListener error! need 2 args: self, function<void(spTrackEntry entry)>");
	...
	{
		var t = Lua_ToTuple<spine::SkeletonAnimation*, Lua_Func>(L, "setCompleteListener error! need 2 args: self, function<void(spTrackEntry entry)>");
	...
	{
		var t = Lua_ToTuple<spine::SkeletonAnimation*, Lua_Func>(L, "setEventListener error! need 2 args: self, function<void(spTrackEntry entry, spEvent event)>");
	...
	{
		var t = Lua_ToTuple<spine::SkeletonAnimation*, spTrackEntry*, Lua_Func>(L, "setTrackStartListener error! need 3 args: self, spTrackEntry entry, function<void(spTrackEntry entry)>");
	...
	{
		var t = Lua_ToTuple<spine::SkeletonAnimation*, spTrackEntry*, Lua_Func>(L, "setTrackInterruptListener error! need 3 args: self, spTrackEntry entry, function<void(spTrackEntry entry)>");
	...
	{
		var t = Lua_ToTuple<spine::SkeletonAnimation*, spTrackEntry*, Lua_Func>(L, "setTrackEndListener error! need 3 args: self, spTrackEntry entry, function<void(spTrackEntry entry)>");
	...
	{
		var t = Lua_ToTuple<spine::SkeletonAnimation*, spTrackEntry*, Lua_Func>(L, "setTrackDisposeListener error! need 3 args: self, spTrackEntry entry, function<void(spTrackEntry entry)>");
	...
	{
		var t = Lua_ToTuple<spine::SkeletonAnimation*, spTrackEntry*, Lua_Func>(L, "setTrackCompleteListener error! need 3 args: self, spTrackEntry entry, function<void(spTrackEntry entry)>");
	...
	{
		var t = Lua_ToTuple<spine::SkeletonAnimation*, spTrackEntry*, Lua_Func>(L, "setTrackEventListener error! need 3 args: self, spTrackEntry entry, function<void(spTrackEntry entry)>");
	...
	{
		var t = Lua_ToTuple<spine::SkeletonAnimation*>(L, "getState error! need 1 args: self");
		var o = std::get<0>(t)->getState();
		return Lua_Pushs(L, o);
	});
