...
inline void Lua_Register_SpriteFrame(lua_State* const& L)
{
	...
	Lua_NewFunc(L, "initWithTexture", [](lua_State* L)
	{
		...
		case 6:
		{
			auto&& t = Lua_ToTuple<cocos2d::SpriteFrame*, cocos2d::Texture2D*, float, float, float, float>(L);
			std::get<0>(t)->initWithTexture(std::get<1>(t), { std::get<2>(t),std::get<3>(t),std::get<4>(t),std::get<5>(t) });
			break;
		}
		case 11:
		{
			auto&& t = Lua_ToTuple<cocos2d::SpriteFrame*, cocos2d::Texture2D*, float, float, float, float, bool, float, float, float, float>(L);
	...
	Lua_NewFunc(L, "initWithTextureFilename", [](lua_State* L)
	{
		...
		case 6:
		{
			auto&& t = Lua_ToTuple<cocos2d::SpriteFrame*, std::string, float, float, float, float>(L);
			std::get<0>(t)->initWithTextureFilename(std::get<1>(t), { std::get<2>(t),std::get<3>(t),std::get<4>(t),std::get<5>(t) });
			break;
		}
		case 11:
		{
			auto&& t = Lua_ToTuple<cocos2d::SpriteFrame*, std::string, float, float, float, float, bool, float, float, float, float>(L);
	...
	Lua_NewFunc(L, "create", [](lua_State* L)
	{
		...
		case 5:
		{
			auto&& t = Lua_ToTuple<std::string, float, float, float, float>(L);
			o = cocos2d::SpriteFrame::create(std::get<0>(t), { std::get<1>(t),std::get<2>(t),std::get<3>(t),std::get<4>(t) });
			break;
		}
		case 10:
		{
			auto&& t = Lua_ToTuple<std::string, float, float, float, float, bool, float, float, float, float>(L);
	...
	Lua_NewFunc(L, "createWithTexture", [](lua_State* L)
	{
		...
		case 10:
		{
			auto&& t = Lua_ToTuple<cocos2d::Texture2D*, float, float, float, float, bool, float, float, float, float>(L);
	...
	{
		auto&& t = Lua_ToTuple<cocos2d::SpriteFrame*>(L, "getRectInPixels error! need 1 args: self");
		auto&& r = std::get<0>(t)->getRectInPixels();
		return Lua_Pushs(L, r.origin.x, r.origin.y, r.size.width, r.size.height);
	});

	Lua_NewFunc(L, "setRectInPixels", [](lua_State* L)
	{
		auto&& t = Lua_ToTuple<cocos2d::SpriteFrame*, float, float, float, float>(L, "setRectInPixels error! need 5 args: self, float rectX, rectY, rectW, rectH");
	...
	{
		auto&& t = Lua_ToTuple<cocos2d::SpriteFrame*>(L, "isRotated error! need 1 args: self");
		auto&& r = std::get<0>(t)->isRotated();
		return Lua_Pushs(L, r);
	});

	Lua_NewFunc(L, "setRotated", [](lua_State* L)
	{
		auto&& t = Lua_ToTuple<cocos2d::SpriteFrame*, bool>(L, "setRotated error! need 2 args: self, bool rotated");
	...
	{
		auto&& t = Lua_ToTuple<cocos2d::SpriteFrame*>(L, "getRect error! need 1 args: self");
		auto&& r = std::get<0>(t)->getRect();
		return Lua_Pushs(L, r.origin.x, r.origin.y, r.size.width, r.size.height);
	});

	Lua_NewFunc(L, "setRect", [](lua_State* L)
	{
		auto&& t = Lua_ToTuple<cocos2d::SpriteFrame*, float, float, float, float>(L, "setRect error! need 5 args: self, float rectX, rectY, rectW, rectH");
	...
	{
		auto&& t = Lua_ToTuple<cocos2d::SpriteFrame*>(L, "getCenterRect error! need 1 args: self");
		auto&& r = std::get<0>(t)->getCenterRect();
		return Lua_Pushs(L, r.origin.x, r.origin.y, r.size.width, r.size.height);
	});

	Lua_NewFunc(L, "setCenterRectInPixels", [](lua_State* L)
	{
		auto&& t = Lua_ToTuple<cocos2d::SpriteFrame*, float, float, float, float>(L, "setCenterRectInPixels error! need 5 args: self, float rectX, rectY, rectW, rectH");
	...
	{
		auto&& t = Lua_ToTuple<cocos2d::SpriteFrame*>(L, "hasCenterRect error! need 1 args: self");
		auto&& r = std::get<0>(t)->hasCenterRect();
		return Lua_Pushs(L, r);
	});

	Lua_NewFunc(L, "getOffsetInPixels", [](lua_State* L)
	{
		auto&& t = Lua_ToTuple<cocos2d::SpriteFrame*>(L, "getOffsetInPixels error! need 1 args: self");
		auto&& r = std::get<0>(t)->getOffsetInPixels();
		return Lua_Pushs(L, r.x, r.y);
	});

	Lua_NewFunc(L, "setOffsetInPixels", [](lua_State* L)
	{
		auto&& t = Lua_ToTuple<cocos2d::SpriteFrame*, float, float>(L, "setOffsetInPixels error! need 3 args: self, float offsetInPixelsX, offsetInPixelsY");
	...
	{
		auto&& t = Lua_ToTuple<cocos2d::SpriteFrame*>(L, "getOriginalSizeInPixels error! need 1 args: self");
		auto&& r = std::get<0>(t)->getOriginalSizeInPixels();
		return Lua_Pushs(L, r.width, r.height);
	});

	Lua_NewFunc(L, "setOriginalSizeInPixels", [](lua_State* L)
	{
		auto&& t = Lua_ToTuple<cocos2d::SpriteFrame*, float, float>(L, "setOriginalSizeInPixels error! need 3 args: self, float sizeInPixelsX, sizeInPixelsY");
	...
	{
		auto&& t = Lua_ToTuple<cocos2d::SpriteFrame*>(L, "getOriginalSize error! need 1 args: self");
		auto&& r = std::get<0>(t)->getOriginalSize();
		return Lua_Pushs(L, r.width, r.height);
	});

	Lua_NewFunc(L, "setOriginalSize", [](lua_State* L)
	{
		auto&& t = Lua_ToTuple<cocos2d::SpriteFrame*, float, float>(L, "setOriginalSize error! need 3 args: self, float sizeInPixelsX, sizeInPixelsY");
	...
	{
		auto&& t = Lua_ToTuple<cocos2d::SpriteFrame*>(L, "getTexture error! need 1 args: self");
		auto&& r = std::get<0>(t)->getTexture();
		return Lua_Pushs(L, r);
	});

	Lua_NewFunc(L, "setTexture", [](lua_State* L)
	{
		auto&& t = Lua_ToTuple<cocos2d::SpriteFrame*, cocos2d::Texture2D*>(L, "setTexture error! need 3 args: self, Texture2D texture");
	...
	{
		auto&& t = Lua_ToTuple<cocos2d::SpriteFrame*>(L, "getOffset error! need 1 args: self");
		auto&& r = std::get<0>(t)->getOffset();
		return Lua_Pushs(L, r.x, r.y);
	});

	Lua_NewFunc(L, "setOffset", [](lua_State* L)
	{
		auto&& t = Lua_ToTuple<cocos2d::SpriteFrame*, float, float>(L, "setOffset error! need 3 args: self, float offsetsX, offsetsY");
	...
	{
		auto&& t = Lua_ToTuple<cocos2d::SpriteFrame*>(L, "getAnchorPoint error! need 1 args: self");
	...
	{
		auto&& t = Lua_ToTuple<cocos2d::SpriteFrame*, float, float>(L, "setAnchorPoint error! need 3 args: self, float offsetsX, offsetsY");
	...
	{
		auto&& t = Lua_ToTuple<cocos2d::SpriteFrame*>(L, "hasAnchorPoint error! need 1 args: self");
		auto&& r = std::get<0>(t)->hasAnchorPoint();
		return Lua_Pushs(L, r);
	});
