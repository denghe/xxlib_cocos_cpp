...
inline void Lua_Register_uiLayout(lua_State* const& L)
{
	...
	{
		auto&& o = new (std::nothrow) cocos2d::ui::Layout();
		if (!o) return 0;
	...
	{
		auto&& o = cocos2d::ui::Layout::create();
		if (!o) return 0;
		return Lua_Push(L, o);
	});
	...
	Lua_NewFunc(L, "setBackGroundImage", [](lua_State* L)
	{
		...
		case 2:
		{
			auto&& t = Lua_ToTuple<cocos2d::ui::Layout*, std::string>(L);
			std::get<0>(t)->setBackGroundImage(std::get<1>(t));
			break;
		}
		case 3:
		{
			auto&& t = Lua_ToTuple<cocos2d::ui::Layout*, std::string, cocos2d::ui::Widget::TextureResType>(L);
	...
	{
		auto&& t = Lua_ToTuple<cocos2d::ui::Layout*, float, float, float, float>(L, "setBackGroundImageCapInsets error! need 5 args: self, float rectX, rectY, rectW, rectH");
	...
	{
		auto&& t = Lua_ToTuple<cocos2d::ui::Layout*>(L, "getBackGroundImageCapInsets error! need 1 args: self");
		auto&& r = std::get<0>(t)->getBackGroundImageCapInsets();
		return Lua_Pushs(L, r.origin.x, r.origin.y, r.size.width, r.size.height);
	});

	Lua_NewFunc(L, "setBackGroundColorType", [](lua_State* L)
	{
		auto&& t = Lua_ToTuple<cocos2d::ui::Layout*, cocos2d::ui::Layout::BackGroundColorType>(L, "setBackGroundColorType error! need 2 args: self, BackGroundColorType type");
	...
	{
		auto&& t = Lua_ToTuple<cocos2d::ui::Layout*>(L, "getBackGroundColorType error! need 1 args: self");
		auto&& r = std::get<0>(t)->getBackGroundColorType();
		return Lua_Pushs(L, r);
	});

	Lua_NewFunc(L, "setBackGroundImageScale9Enabled", [](lua_State* L)
	{
		auto&& t = Lua_ToTuple<cocos2d::ui::Layout*, bool>(L, "setBackGroundImageScale9Enabled error! need 2 args: self, bool enabled");
	...
	{
		auto&& t = Lua_ToTuple<cocos2d::ui::Layout*>(L, "isBackGroundImageScale9Enabled error! need 1 args: self");
		auto&& r = std::get<0>(t)->isBackGroundImageScale9Enabled();
		return Lua_Pushs(L, r);
	});
	...
	Lua_NewFunc(L, "setBackGroundColor", [](lua_State* L)
	{
		...
		case 4:
		{
			auto&& t = Lua_ToTuple<cocos2d::ui::Layout*, GLubyte, GLubyte, GLubyte>(L);
			std::get<0>(t)->setBackGroundColor({ std::get<1>(t), std::get<2>(t), std::get<3>(t) });
			break;
		}
		case 7:
		{
			auto&& t = Lua_ToTuple<cocos2d::ui::Layout*, GLubyte, GLubyte, GLubyte, GLubyte, GLubyte, GLubyte>(L);
	...
	{
		auto&& t = Lua_ToTuple<cocos2d::ui::Layout*>(L, "getBackGroundColor error! need 1 args: self");
		auto&& r = std::get<0>(t)->getBackGroundColor();
		return Lua_Pushs(L, r.r, r.g, r.b);
	});

	Lua_NewFunc(L, "getBackGroundStartColor", [](lua_State* L)
	{
		auto&& t = Lua_ToTuple<cocos2d::ui::Layout*>(L, "getBackGroundStartColor error! need 1 args: self");
		auto&& r = std::get<0>(t)->getBackGroundStartColor();
		return Lua_Pushs(L, r.r, r.g, r.b);
	});

	Lua_NewFunc(L, "getBackGroundEndColor", [](lua_State* L)
	{
		auto&& t = Lua_ToTuple<cocos2d::ui::Layout*>(L, "getBackGroundEndColor error! need 1 args: self");
		auto&& r = std::get<0>(t)->getBackGroundEndColor();
		return Lua_Pushs(L, r.r, r.g, r.b);
	});

	Lua_NewFunc(L, "setBackGroundColorOpacity", [](lua_State* L)
	{
		auto&& t = Lua_ToTuple<cocos2d::ui::Layout*, int>(L, "setBackGroundColorOpacity error! need 2 args: self, GLubyte opacity");
	...
	{
		auto&& t = Lua_ToTuple<cocos2d::ui::Layout*>(L, "getBackGroundColorOpacity error! need 1 args: self");
		auto&& r = std::get<0>(t)->getBackGroundColorOpacity();
		return Lua_Pushs(L, r);
	});

	Lua_NewFunc(L, "setBackGroundColorVector", [](lua_State* L)
	{
		auto&& t = Lua_ToTuple<cocos2d::ui::Layout*, float, float>(L, "setBackGroundColorVector error! need 3 args: self, vectorX, vectorY");
	...
	{
		auto&& t = Lua_ToTuple<cocos2d::ui::Layout*>(L, "getBackGroundColorVector error! need 1 args: self");
		auto&& r = std::get<0>(t)->getBackGroundColorVector();
		return Lua_Pushs(L, r.x, r.y);
	});

	Lua_NewFunc(L, "setBackGroundImageColor", [](lua_State* L)
	{
		auto&& t = Lua_ToTuple<cocos2d::ui::Layout*, GLubyte, GLubyte, GLubyte>(L, "setBackGroundImageColor error! need 4 args: self, GLubyte color r, g, b");
	...
	{
		auto&& t = Lua_ToTuple<cocos2d::ui::Layout*, int>(L, "setBackGroundImageOpacity error! need 2 args: self, GLubyte opacity");
	...
	{
		auto&& t = Lua_ToTuple<cocos2d::ui::Layout*>(L, "getBackGroundImageColor error! need 1 args: self");
		auto&& r = std::get<0>(t)->getBackGroundImageColor();
		return Lua_Pushs(L, r.r, r.g, r.b);
	});

	Lua_NewFunc(L, "getBackGroundImageOpacity", [](lua_State* L)
	{
		auto&& t = Lua_ToTuple<cocos2d::ui::Layout*>(L, "getBackGroundImageOpacity error! need 1 args: self");
		auto&& r = std::get<0>(t)->getBackGroundImageOpacity();
		return Lua_Pushs(L, r);
	});

	Lua_NewFunc(L, "removeBackGroundImage", [](lua_State* L)
	{
		auto&& t = Lua_ToTuple<cocos2d::ui::Layout*>(L, "removeBackGroundImage error! need 1 args: self");
	...
	{
		auto&& t = Lua_ToTuple<cocos2d::ui::Layout*>(L, "getBackGroundImageTextureSize error! need 1 args: self");
		auto&& r = std::get<0>(t)->getBackGroundImageTextureSize();
		return Lua_Pushs(L, r.width, r.height);
	});

	Lua_NewFunc(L, "setClippingEnabled", [](lua_State* L)
	{
		auto&& t = Lua_ToTuple<cocos2d::ui::Layout*, bool>(L, "setClippingEnabled error! need 2 args: self, bool enabled");
	...
	{
		auto&& t = Lua_ToTuple<cocos2d::ui::Layout*, cocos2d::ui::Layout::ClippingType>(L, "setClippingType error! need 2 args: self, ClippingType type");
	...
	{
		auto&& t = Lua_ToTuple<cocos2d::ui::Layout*>(L, "getClippingType error! need 1 args: self");
		auto&& r = std::get<0>(t)->getClippingType();
		return Lua_Pushs(L, r);
	});

	Lua_NewFunc(L, "isClippingEnabled", [](lua_State* L)
	{
		auto&& t = Lua_ToTuple<cocos2d::ui::Layout*>(L, "isClippingEnabled error! need 1 args: self");
		auto&& r = std::get<0>(t)->isClippingEnabled();
		return Lua_Pushs(L, r);
	});

	Lua_NewFunc(L, "setLayoutType", [](lua_State* L)
	{
		auto&& t = Lua_ToTuple<cocos2d::ui::Layout*, cocos2d::ui::Layout::Type>(L, "setLayoutType error! need 2 args: self, Type type");
	...
	{
		auto&& t = Lua_ToTuple<cocos2d::ui::Layout*>(L, "getLayoutType error! need 1 args: self");
		auto&& r = std::get<0>(t)->getLayoutType();
		return Lua_Pushs(L, r);
	});

	Lua_NewFunc(L, "forceDoLayout", [](lua_State* L)
	{
		auto&& t = Lua_ToTuple<cocos2d::ui::Layout*>(L, "forceDoLayout error! need 2 args: self");
	...
	{
		auto&& t = Lua_ToTuple<cocos2d::ui::Layout*>(L, "requestDoLayout error! need 2 args: self");
	...
	{
		auto&& t = Lua_ToTuple<cocos2d::ui::Layout*, bool>(L, "setLoopFocus error! need 2 args: self, bool loop");
	...
	{
		auto&& t = Lua_ToTuple<cocos2d::ui::Layout*>(L, "isLoopFocus error! need 1 args: self");
		auto&& r = std::get<0>(t)->isLoopFocus();
		return Lua_Pushs(L, r);
	});

	Lua_NewFunc(L, "setPassFocusToChild", [](lua_State* L)
	{
		auto&& t = Lua_ToTuple<cocos2d::ui::Layout*, bool>(L, "setPassFocusToChild error! need 2 args: self, bool pass");
	...
	{
		auto&& t = Lua_ToTuple<cocos2d::ui::Layout*>(L, "isPassFocusToChild error! need 1 args: self");
		auto&& r = std::get<0>(t)->isPassFocusToChild();
		return Lua_Pushs(L, r);
	});
	...
	{
		auto&& t = Lua_ToTuple<cocos2d::ui::Layout*>(L, "getRenderFile error! need 1 args: self");
