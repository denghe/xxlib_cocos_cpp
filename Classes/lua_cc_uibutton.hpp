...
inline void Lua_Register_uiButton(lua_State* const& L)
{
	...
	{
		auto&& o = new (std::nothrow) cocos2d::ui::Button();
		if (!o) return 0;
	...
	Lua_NewFunc(L, "init", [](lua_State* L)
	{
		...
		case 1:
		{
			auto&& t = Lua_ToTuple<cocos2d::ui::Button*>(L);
			std::get<0>(t)->init();
			break;
		}
		case 2:
		{
			auto&& t = Lua_ToTuple<cocos2d::ui::Button*, std::string>(L);
			std::get<0>(t)->init(std::get<1>(t));
			break;
		}
		case 3:
		{
			auto&& t = Lua_ToTuple<cocos2d::ui::Button*, std::string, std::string>(L);
			std::get<0>(t)->init(std::get<1>(t), std::get<2>(t));
			break;
		}
		case 4:
		{
			auto&& t = Lua_ToTuple<cocos2d::ui::Button*, std::string, std::string, std::string>(L);
			std::get<0>(t)->init(std::get<1>(t), std::get<2>(t), std::get<3>(t));
			break;
		}
		case 5:
		{
			auto&& t = Lua_ToTuple<cocos2d::ui::Button*, std::string, std::string, std::string, cocos2d::ui::Widget::TextureResType>(L);
	...
	Lua_NewFunc(L, "create", [](lua_State* L)
	{
		...
		case 3:
		{
			auto&& t = Lua_ToTuple<std::string, std::string, std::string>(L);
			o = cocos2d::ui::Button::create(std::get<0>(t), std::get<1>(t), std::get<2>(t));
			break;
		}
		case 4:
		{
			auto&& t = Lua_ToTuple<std::string, std::string, std::string, cocos2d::ui::Widget::TextureResType>(L);
	...
	Lua_NewFunc(L, "loadTextureNormal", [](lua_State* L)
	{
		...
		case 3:
		{
			auto&& t = Lua_ToTuple<cocos2d::ui::Button*, std::string, cocos2d::ui::Widget::TextureResType>(L);
	...
	{
		auto&& t = Lua_ToTuple<cocos2d::ui::Button*, float, float, float, float>(L, "setCapInsets error! need 5 args: self, float rectX, rectY, rectW, rectH");
	...
	{
		auto&& t = Lua_ToTuple<cocos2d::ui::Button*, float, float, float, float>(L, "setCapInsetsNormalRenderer error! need 5 args: self, float rectX, rectY, rectW, rectH");
	...
	{
		auto&& t = Lua_ToTuple<cocos2d::ui::Button*>(L, "getCapInsetsNormalRenderer error! need 1 args: self");
	...
	{
		auto&& t = Lua_ToTuple<cocos2d::ui::Button*, float, float, float, float>(L, "setCapInsetsPressedRenderer error! need 5 args: self, float rectX, rectY, rectW, rectH");
	...
	{
		auto&& t = Lua_ToTuple<cocos2d::ui::Button*>(L, "getCapInsetsPressedRenderer error! need 1 args: self");
	...
	{
		auto&& t = Lua_ToTuple<cocos2d::ui::Button*, float, float, float, float>(L, "setCapInsetsDisabledRenderer error! need 5 args: self, float rectX, rectY, rectW, rectH");
	...
	{
		auto&& t = Lua_ToTuple<cocos2d::ui::Button*>(L, "getCapInsetsDisabledRenderer error! need 1 args: self");
	...
	{
		auto&& t = Lua_ToTuple<cocos2d::ui::Button*, bool>(L, "setScale9Enabled error! need 2 args: self, bool enabled");
	...
	{
		auto&& t = Lua_ToTuple<cocos2d::ui::Button*>(L, "isScale9Enabled error! need 1 args: self");
	...
	{
		auto&& t = Lua_ToTuple<cocos2d::ui::Button*, bool>(L, "setPressedActionEnabled error! need 2 args: self, bool enabled");
	...
	{
		auto&& t = Lua_ToTuple<cocos2d::ui::Button*>(L, "getTitleRenderer error! need 1 args: self");
		auto&& r = std::get<0>(t)->getTitleRenderer();
		return Lua_Pushs(L, r);
	});

	Lua_NewFunc(L, "setTitleText", [](lua_State* L)
	{
		auto&& t = Lua_ToTuple<cocos2d::ui::Button*, std::string>(L, "setTitleText error! need 2 args: self, string text");
	...
	{
		auto&& t = Lua_ToTuple<cocos2d::ui::Button*>(L, "getTitleText error! need 1 args: self");
		auto&& r = std::get<0>(t)->getTitleText();
		return Lua_Pushs(L, r);
	});

	Lua_NewFunc(L, "setTitleColor", [](lua_State* L)
	{
		auto&& t = Lua_ToTuple<cocos2d::ui::Button*, GLubyte, GLubyte, GLubyte>(L, "setTitleColor error! need 4 args: self, GLubyte r, g, b");
	...
	{
		auto&& t = Lua_ToTuple<cocos2d::ui::Button*>(L, "getTitleColor error! need 1 args: self");
		auto&& r = std::get<0>(t)->getTitleColor();
		return Lua_Pushs(L, r.r, r.g, r.b);
	});

	Lua_NewFunc(L, "setTitleFontSize", [](lua_State* L)
	{
		auto&& t = Lua_ToTuple<cocos2d::ui::Button*, float>(L, "setTitleFontSize error! need 2 args: self, float size");
	...
	{
		auto&& t = Lua_ToTuple<cocos2d::ui::Button*>(L, "getTitleFontSize error! need 1 args: self");
		auto&& r = std::get<0>(t)->getTitleFontSize();
		return Lua_Pushs(L, r);
	});

	Lua_NewFunc(L, "setTitleFontName", [](lua_State* L)
	{
		auto&& t = Lua_ToTuple<cocos2d::ui::Button*, std::string>(L, "setTitleFontName error! need 2 args: self, string name");
	...
	{
		auto&& t = Lua_ToTuple<cocos2d::ui::Button*>(L, "getTitleFontName error! need 1 args: self");
		auto&& r = std::get<0>(t)->getTitleFontName();
		return Lua_Pushs(L, r);
	});
	...
	Lua_NewFunc(L, "setTitleAlignment", [](lua_State* L)
	{
		...
		case 2:
		{
			auto&& t = Lua_ToTuple<cocos2d::ui::Button*, cocos2d::TextHAlignment>(L);
			std::get<0>(t)->setTitleAlignment(std::get<1>(t));
			break;
		}
		case 3:
		{
			auto&& t = Lua_ToTuple<cocos2d::ui::Button*, cocos2d::TextHAlignment, cocos2d::TextVAlignment>(L);
	...
	{
		auto&& t = Lua_ToTuple<cocos2d::ui::Button*, cocos2d::Label*>(L, "setTitleLabel error! need 2 args: self, Label label");
	...
	{
		auto&& t = Lua_ToTuple<cocos2d::ui::Button*>(L, "getTitleLabel error! need 1 args: self");
		auto&& r = std::get<0>(t)->getTitleLabel();
		return Lua_Pushs(L, r);
	});

	Lua_NewFunc(L, "setZoomScale", [](lua_State* L)
	{
		auto&& t = Lua_ToTuple<cocos2d::ui::Button*, float>(L, "setZoomScale error! need 2 args: self, float scale");
	...
	{
		auto&& t = Lua_ToTuple<cocos2d::ui::Button*>(L, "getZoomScale error! need 1 args: self");
		auto&& r = std::get<0>(t)->getZoomScale();
		return Lua_Pushs(L, r);
	});

	Lua_NewFunc(L, "getRendererNormal", [](lua_State* L)
	{
		auto&& t = Lua_ToTuple<cocos2d::ui::Button*>(L, "getRendererNormal error! need 1 args: self");
		auto&& r = std::get<0>(t)->getRendererNormal();
		return Lua_Pushs(L, r);
	});

	Lua_NewFunc(L, "getRendererClicked", [](lua_State* L)
	{
		auto&& t = Lua_ToTuple<cocos2d::ui::Button*>(L, "getRendererClicked error! need 1 args: self");
		auto&& r = std::get<0>(t)->getRendererClicked();
		return Lua_Pushs(L, r);
	});

	Lua_NewFunc(L, "getRendererDisabled", [](lua_State* L)
	{
		auto&& t = Lua_ToTuple<cocos2d::ui::Button*>(L, "getRendererDisabled error! need 1 args: self");
		auto&& r = std::get<0>(t)->getRendererDisabled();
		return Lua_Pushs(L, r);
	});

	Lua_NewFunc(L, "resetNormalRender", [](lua_State* L)
	{
		auto&& t = Lua_ToTuple<cocos2d::ui::Button*>(L, "resetNormalRender error! need 1 args: self");
	...
	{
		auto&& t = Lua_ToTuple<cocos2d::ui::Button*>(L, "resetPressedRender error! need 1 args: self");
	...
	{
		auto&& t = Lua_ToTuple<cocos2d::ui::Button*>(L, "resetDisabledRender error! need 1 args: self");
	...
	{
		auto&& t = Lua_ToTuple<cocos2d::ui::Button*>(L, "getNormalTextureSize error! need 1 args: self");
		auto&& r = std::get<0>(t)->getNormalTextureSize();
