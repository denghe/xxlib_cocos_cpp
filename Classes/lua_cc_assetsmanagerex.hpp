...
inline void Lua_Register_AssetsManagerEx(lua_State* const& L)
{
	...
	{
		var t = Lua_ToTuple<cocos2d::extension::Manifest*>(L, "isVersionLoaded error! need 1 args: self");
		var r = std::get<0>(t)->isVersionLoaded();
		return Lua_Pushs(L, r);
	});

	Lua_NewFunc(L, "isLoaded", [](lua_State* L)
	{
		var t = Lua_ToTuple<cocos2d::extension::Manifest*>(L, "isLoaded error! need 1 args: self");
		var r = std::get<0>(t)->isLoaded();
		return Lua_Pushs(L, r);
	});

	Lua_NewFunc(L, "getPackageUrl", [](lua_State* L)
	{
		var t = Lua_ToTuple<cocos2d::extension::Manifest*>(L, "getPackageUrl error! need 1 args: self");
		var r = std::get<0>(t)->getPackageUrl();
		return Lua_Pushs(L, r);
	});

	Lua_NewFunc(L, "getManifestFileUrl", [](lua_State* L)
	{
		var t = Lua_ToTuple<cocos2d::extension::Manifest*>(L, "getManifestFileUrl error! need 1 args: self");
		var r = std::get<0>(t)->getManifestFileUrl();
		return Lua_Pushs(L, r);
	});

	Lua_NewFunc(L, "getVersion", [](lua_State* L)
	{
		var t = Lua_ToTuple<cocos2d::extension::Manifest*>(L, "getVersion error! need 1 args: self");
		var r = std::get<0>(t)->getVersion();
		return Lua_Pushs(L, r);
	});

	Lua_NewFunc(L, "getSearchPaths", [](lua_State* L)
	{
		var t = Lua_ToTuple<cocos2d::extension::Manifest*>(L, "getSearchPaths error! need 1 args: self");
		var r = std::get<0>(t)->getSearchPaths();
		return Lua_Pushs(L, r);
	});
	...
	{
		var t = Lua_ToTuple<std::string, std::string>(L, "create AssetsManagerEx error! need 2 args: string manifestUrl, storagePath");
		var o = cocos2d::extension::AssetsManagerEx::create(std::get<0>(t), std::get<1>(t));
		if (!o) return 0;
	...
	{
		var t = Lua_ToTuple<cocos2d::extension::AssetsManagerEx*>(L, "checkUpdate error! need 1 args: self");
	...
	{
		var t = Lua_ToTuple<cocos2d::extension::AssetsManagerEx*>(L, "update error! need 1 args: self");
		std::get<0>(t)->update();
		return 0;
	});
	...
	{
		var t = Lua_ToTuple<cocos2d::extension::AssetsManagerEx*>(L, "downloadFailedAssets error! need 1 args: self");
	...
	{
		var t = Lua_ToTuple<cocos2d::extension::AssetsManagerEx*>(L, "getState error! need 1 args: self");
		var r = std::get<0>(t)->getState();
		return Lua_Pushs(L, r);
	});

	Lua_NewFunc(L, "getStoragePath", [](lua_State* L)
	{
		var t = Lua_ToTuple<cocos2d::extension::AssetsManagerEx*>(L, "getStoragePath error! need 1 args: self");
		var r = std::get<0>(t)->getStoragePath();
		return Lua_Pushs(L, r);
	});

	Lua_NewFunc(L, "getLocalManifest", [](lua_State* L)
	{
		var t = Lua_ToTuple<cocos2d::extension::AssetsManagerEx*>(L, "getLocalManifest error! need 1 args: self");
		var r = std::get<0>(t)->getLocalManifest();
		return Lua_Pushs(L, r);
	});

	Lua_NewFunc(L, "getRemoteManifest", [](lua_State* L)
	{
		var t = Lua_ToTuple<cocos2d::extension::AssetsManagerEx*>(L, "getRemoteManifest error! need 1 args: self");
		var r = std::get<0>(t)->getRemoteManifest();
		return Lua_Pushs(L, r);
	});

	Lua_NewFunc(L, "getMaxConcurrentTask", [](lua_State* L)
	{
		var t = Lua_ToTuple<cocos2d::extension::AssetsManagerEx*>(L, "getMaxConcurrentTask error! need 1 args: self");
		var r = std::get<0>(t)->getMaxConcurrentTask();
		return Lua_Pushs(L, r);
	});

	Lua_NewFunc(L, "setMaxConcurrentTask", [](lua_State* L)
	{
		var t = Lua_ToTuple<cocos2d::extension::AssetsManagerEx*, int>(L, "setMaxConcurrentTask error! need 2 args: self, int max");
	...
	{
		var t = Lua_ToTuple<cocos2d::extension::AssetsManagerEx*, Lua_Func>(L, "setVersionCompareHandle error! need 2 args: self, function<int(string versionA, string versionB)>& handle");
		std::get<0>(t)->setVersionCompareHandle([f = std::move(std::get<1>(t))](const std::string& versionA, const std::string& versionB)
		{
			...
			var rt = Lua_ToTuple<int>(gLua, "setVersionCompareHandle's function error! need 1 results: int");
			lua_settop(gLua, 0);
			return std::get<0>(rt);
		});
		return 0;
	...
	{
		var t = Lua_ToTuple<cocos2d::extension::AssetsManagerEx*, Lua_Func>(L, "setVerifyCallback error! need 2 args: self, function<bool(string path, Manifest::Asset[ string md5, path, bool compressed, float size, int downloadState ] asset)>& callback");
		std::get<0>(t)->setVerifyCallback([f = std::move(std::get<1>(t))](const std::string& path, cocos2d::extension::Manifest::Asset asset)
		{
			...
			var rt = Lua_ToTuple<int>(gLua, "setVerifyCallback's function error! need 1 results: bool");
			lua_settop(gLua, 0);
			return std::get<0>(rt);
		});
		return 0;
