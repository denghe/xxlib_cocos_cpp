...
namespace PKG {
	struct PkgGenMd5 {
		inline static const std::string value = "3ccea2a0a6ad09a64cbc2acf031c81c4";
    };
...
namespace CatchFish {
    // 场景基础配置参数 ( 主要来自 db )
    struct SceneInfo;
    using SceneInfo_s = std::shared_ptr<SceneInfo>;
    using SceneInfo_w = std::weak_ptr<SceneInfo>;
...
namespace CatchFish {
    ...
    struct SceneInfo : xx::Object {
        ...
        typedef SceneInfo ThisType;
        typedef xx::Object BaseType;
	    SceneInfo() = default;
		SceneInfo(SceneInfo const&) = delete;
		SceneInfo& operator=(SceneInfo const&) = delete;
    ...
    struct Scene : xx::Object {
        // 场景基础配置参数 ( 主要来自 db )
        PKG::CatchFish::SceneInfo_s info;
        // 帧编号, 每帧 + 1. 用于同步
        int32_t frameNumber = 0;
        // 本地鱼生成专用随机数发生器
        ::xx::Random_s rnd;
...
namespace xx {
    ...
    template<> struct TypeId<PKG::CatchFish::SceneInfo> { static const uint16_t value = 7; };
...
namespace CatchFish {
    inline uint16_t SceneInfo::GetTypeId() const noexcept {
        return 7;
    }
    inline void SceneInfo::ToBBuffer(xx::BBuffer& bb) const noexcept {
    ...
    inline int SceneInfo::FromBBuffer(xx::BBuffer& bb) noexcept {
    ...
    inline void SceneInfo::InitCascade() noexcept {
    }
    inline void SceneInfo::ToString(std::string& s) const noexcept {
        if (this->toStringFlag)
        {
        	xx::Append(s, "[ \"***** recursived *****\" ]");
        	return;
        ...
        xx::Append(s, "{ \"pkgTypeName\":\"CatchFish.SceneInfo\", \"pkgTypeId\":", GetTypeId());
        ToStringCore(s);
        xx::Append(s, " }");
        
        this->SetToStringFlag(false);
    }
    inline void SceneInfo::ToStringCore(std::string& s) const noexcept {
        this->BaseType::ToStringCore(s);
    ...
    inline void Scene::InitCascade() noexcept {
        ...
        if (this->items) {
            this->items->InitCascade();
        }
        if (this->borns) {
            this->borns->InitCascade();
        }
        if (this->stage) {
            this->stage->InitCascade();
        }
        if (this->freeSits) {
    ...
    inline void Item::InitCascade() noexcept {
    }
    ...
    inline void MoveItem::InitCascade() noexcept {
    ...
    inline int Fish::FromBBuffer(xx::BBuffer& bb) noexcept {
        ...
        if (int r = bb.Read(this->wayFrameDistance)) return r;
    ...
    inline void Fish::ToStringCore(std::string& s) const noexcept {
        ...
        xx::Append(s, ", \"wayFrameDistance\":", this->wayFrameDistance);
    ...
    inline void Timer::InitCascade() noexcept {
    }
    ...
    inline void FishBorn::InitCascade() noexcept {
        this->BaseType::InitCascade();
        if (this->fish) {
            this->fish->InitCascade();
        }
    }
    ...
    inline void Way::InitCascade() noexcept {
        if (this->points) {
            this->points->InitCascade();
        }
    }
...
namespace CatchFish::Events {
    ...
    inline void Event::InitCascade() noexcept {
    }
    ...
    inline void Enter::InitCascade() noexcept {
        this->BaseType::InitCascade();
    }
    ...
    inline void Leave::InitCascade() noexcept {
        this->BaseType::InitCascade();
    }
    ...
    inline void NoMoney::InitCascade() noexcept {
        this->BaseType::InitCascade();
    }
    ...
    inline void Charge::InitCascade() noexcept {
        this->BaseType::InitCascade();
    }
    ...
    inline void FishDead::InitCascade() noexcept {
        this->BaseType::InitCascade();
        if (this->fishDeads) {
            this->fishDeads->InitCascade();
        }
    }
    ...
    inline void PushWeapon::InitCascade() noexcept {
        this->BaseType::InitCascade();
        if (this->weapon) {
            this->weapon->InitCascade();
        }
    }
    ...
    inline void PushFish::InitCascade() noexcept {
        this->BaseType::InitCascade();
        if (this->born) {
            this->born->InitCascade();
        }
    }
    ...
    inline void OpenAutoLock::InitCascade() noexcept {
        this->BaseType::InitCascade();
    }
    ...
    inline void Aim::InitCascade() noexcept {
        this->BaseType::InitCascade();
    }
    ...
    inline void CloseAutoLock::InitCascade() noexcept {
        this->BaseType::InitCascade();
    }
    ...
    inline void OpenAutoFire::InitCascade() noexcept {
        this->BaseType::InitCascade();
    }
    ...
    inline void CloseAutoFire::InitCascade() noexcept {
        this->BaseType::InitCascade();
    }
    ...
    inline void Fire::InitCascade() noexcept {
        this->BaseType::InitCascade();
    }
    ...
    inline void CannonSwitch::InitCascade() noexcept {
        this->BaseType::InitCascade();
    }
    ...
    inline void CannonCoinChange::InitCascade() noexcept {
        this->BaseType::InitCascade();
    }
...
namespace CatchFish::Stages {
    ...
    inline void Stage::InitCascade() noexcept {
        if (this->timers) {
            this->timers->InitCascade();
        }
    }
    ...
    inline void Script::InitCascade() noexcept {
        this->BaseType::InitCascade();
    }
...
namespace CatchFish::Configs {
    ...
    inline void Physics::InitCascade() noexcept {
        if (this->polygons) {
...
namespace PKG {
	struct AllTypesRegister {
        AllTypesRegister() {
	        ...
	        xx::BBuffer::Register<PKG::CatchFish::SceneInfo>(7);
